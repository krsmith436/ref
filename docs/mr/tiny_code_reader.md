|  🔗 [Tiny Code Reader Developer Guide](https://github.com/moonshine-ai/tiny_code_reader_docs/blob/main/README.md#reading-data)  |

## Introduction

The [Tiny Code Reader](https://usfl.ink/tcr) from [Useful Sensors](https://usefulsensors.com) is a small, low-cost hardware module that reads QR codes. It's designed to be a simple way to provision a system, for example by providing the wifi network name and password, or to provide input when there's no keyboard.
...
- Arduino: [github.com/usefulsensors/tiny_code_reader_arduino](https://github.com/usefulsensors/tiny_code_reader_arduino)
...
## Create Giebel Throttle QR Code
...
<img src="../img/qr-code-east.png" width="288" height="288">
